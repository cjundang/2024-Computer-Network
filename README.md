...
| **Lec** | **Title & Topics**                                                                                         | **LO**                                                 | **Activities**                                        | **Task**                                           |
| ------: | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------- | -------------------------------------------------- |
|       1 | Introduction to Networking and the OSI Model<br> - Network Basics<br> - OSI vs. TCP/IP<br> - Encapsulation | Terms & Explain networking purpose and OSI layer roles | Layer mapping activity, discussion                    | OSI model diagramming + terminology flashcards     |
|       2 | Connecting to the World<br> - IP Addressing<br> - Subnet Mask<br> - Gateway, DNS, DHCP                     | Identify key addressing elements and network setup     | Demonstration with CLI tools (ping, ipconfig)         | IP config worksheet + command line outputs         |
|       3 | Network Devices and Architecture<br> - Switches, Routers<br> - Network Topologies                          | Distinguish device roles and network layout design     | Device comparison + physical/logical topology drawing | Device-function chart + topology matching task     |
|       4 | Switch Configuration<br> - Cisco IOS<br> - VLAN Intro                                                      | Apply basic switch configuration in CLI                | Packet Tracer lab: assign IP, enable ports            | VLAN config lab + switch CLI checklist             |
|       5 | VLAN and Broadcast Segmentation<br> - VLAN benefits<br> - Broadcast reduction<br> - Dumbbell topology      | Segment broadcast domains using VLANs                  | Trunking demo, VLAN broadcast scope test              | Design and configure VLANs for small network       |
|       6 | IP Addressing and Subnetting                                                                               | Calculate subnets, host ranges, and usable IPs         | Subnetting calculation drills                         | Subnetting worksheet + CIDR notation practice      |
|       7 | Connecting to the World (Advanced)                                                                         | Trace data flows through routers and gateways          | Default gateway and path tracing simulation           | Traceroute task + diagram of network path          |
|       8 | Routing Concepts<br> - Static vs Dynamic Routing                                                           | Configure static routes and understand path selection  | Packet Tracer routing lab                             | Routing table writing and ping test                |
|       9 | Network Design: Small Room                                                                                 | Plan layout and address scheme for SOHO setup          | Create mini-design proposal with justification        | Design small business network with device list     |
|      10 | Network Design: Organization                                                                               | Plan structured LAN with departments, VLANs, IP plans  | Group design planning with inter-VLAN routing         | Full topology plan + addressing + documentation    |
|      11 | Traffic Analysis<br> - Using Wireshark                                                                     | Interpret traffic flows, identify protocols            | Capture DNS, DHCP, HTTP traffic with Wireshark        | PCAP analysis + protocol table + screenshot notes  |
|      12 | Server in Network                                                                                          | Setup services like DHCP/DNS/HTTP                      | Configure and test server roles in simulation         | Packet Tracer server-client scenario + config test |
